<?php
    ...
    if(
        ...
        $sqlQuery3 = $DB_Connection->prepare("DELETE FROM appointments WHERE Email = :temp_email " );
                      
       if( $sqlQuery3->execute([
...
<html lang="en" dir="ltr">
  ...
  <div class="container-lg">
    ...
    <h1><i>Delete Your Appointment!</i></h1>
    ...
    <?php foreach($dataRecords as $doctors): ?>      <!--- the loop generates a row for each record --->
            ...
            <input type="submit" style="color:red" value="DELETE THIS APPOINTMENT" id="submit" onclick="validation()" >
