<?php
    ...
    $message = '';
      ...
      if(
          ...
          $sql = 'INSERT INTO patient(name, email, password,height,gender,address,age) 
                              VALUES(:temp_name, :temp_email, :temp_password,:temp_height,:temp_gender,:temp_address,:temp_age)';
